...
class Player(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.images = [
            pg.image.load("./Downloads/20181222061032!Mario_In_Mario's_Time_Machine_(NES).png"),
            pg.transform.flip(pg.image.load("./Downloads/20181222061032!Mario_In_Mario's_Time_Machine_(NES).png"), True, False),
        ]
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pg.image.load("./Downloads/coin.png")
